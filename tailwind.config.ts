  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        slamDown: {
          "0%": { transform: "translateY(-16px) scale(1.5)", opacity: "0" },
          "30%": { transform: "translateY(0) scale(1)", opacity: "1" },
          "45%": { transform: "translateY(2px) scale(0.9)", opacity: "1" },
          "75%": { transform: "translateY(-2px) scale(1)", opacity: "1" },
      ...
      animation: {
        ...
        floatDown: "floatDown 1.05s ease-out forwards",
        popIn: "popIn 0.25s ease-out",
        critPulse: "critPulse 1.1s ease-in-out infinite",
        critRing: "critRing 0.55s ease-out forwards",
        slamDown: "slamDown 0.85s ease-out forwards",
        barFlash: "barFlash 0.35s ease-out forwards",
      },
    },
  },
  plugins: [],
